...
function Modal() {
  ...
  return (
    <MuiModal open={showModal} onClose={handleClose} className="fixex !top-7 left-0 right-0 mx-auto w-full max-w-5xl
    overflow-hidden overflow-scroll rounded-md scrollbar-hide">
      <>
